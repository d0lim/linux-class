...
#define PXT4_CLUSTER_SIZE(s) (PXT4_BLOCK_SIZE(s) << PXT4_SB(s)->s_cluster_bits)
#ifdef __KERNEL__
...
#else
#define PXT4_INODE_SIZE(s) (((s)->s_rev_level == PXT4_GOOD_OLD_REV) ? PXT4_GOOD_OLD_INODE_SIZE : (s)->s_inode_size)
#define PXT4_FIRST_INO(s) (((s)->s_rev_level == PXT4_GOOD_OLD_REV) ? PXT4_GOOD_OLD_FIRST_INO : (s)->s_first_ino)
#endif
...
#define PXT4_FITS_IN_INODE(pxt4_inode, einode, field)             \
	((offsetof(typeof(*pxt4_inode), field) +                      \
	  sizeof((pxt4_inode)->field)) <= (PXT4_GOOD_OLD_INODE_SIZE + \
...
{
	return pxt4_has_feature_largedir(sb) ? PXT4_HTREE_LEVEL : PXT4_HTREE_LEVEL_COMPAT;
}
...
extern __printf(4, 5) void __pxt4_error(struct super_block *, const char *, unsigned int,
										const char *, ...);
extern __printf(5, 6) void __pxt4_error_inode(struct inode *, const char *, unsigned int, pxt4_fsblk_t,
											  const char *, ...);
extern __printf(5, 6) void __pxt4_error_file(struct file *, const char *, unsigned int, pxt4_fsblk_t,
											 const char *, ...);
extern void __pxt4_std_error(struct super_block *, const char *,
							 unsigned int, int);
extern __printf(4, 5) void __pxt4_abort(struct super_block *, const char *, unsigned int,
										const char *, ...);
extern __printf(4, 5) void __pxt4_warning(struct super_block *, const char *, unsigned int,
										  const char *, ...);
extern __printf(4, 5) void __pxt4_warning_inode(const struct inode *inode, const char *function,
												unsigned int line, const char *fmt, ...);
extern __printf(3, 4) void __pxt4_msg(struct super_block *, const char *, const char *, ...);
extern void __dump_mmp_msg(struct super_block *, struct mmp_struct *mmp,
						   const char *, unsigned int, const char *);
extern __printf(7, 8) void __pxt4_grp_locked_error(const char *, unsigned int,
...
static inline struct pxt4_group_info *pxt4_get_group_info(struct super_block *sb,
														  pxt4_group_t group)
{
...
static const unsigned char pxt4_type_by_mode[(S_IFMT >> S_SHIFT) + 1] = {
	...
	[S_IFDIR >>
		S_SHIFT] = PXT4_FT_DIR,
	[S_IFCHR >>
		S_SHIFT] = PXT4_FT_CHRDEV,
	[S_IFBLK >>
		S_SHIFT] = PXT4_FT_BLKDEV,
	[S_IFIFO >>
		S_SHIFT] = PXT4_FT_FIFO,
	[S_IFSOCK >>
		S_SHIFT] = PXT4_FT_SOCK,
	[S_IFLNK >>
		S_SHIFT] = PXT4_FT_SYMLINK,
};
